...
const ownerNumber = ['94704932651']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/session/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("ESHU-MD=", '');
...
console.log("𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙸𝙽𝙶 ESHU 𝙼𝙳 🎭...");
...
console.log('ESHU 𝙼𝙳 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳 𝚃𝙾 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 𝙴𝙽𝙹𝙾𝚈 ✅')

let up = `> Qᴜᴇᴇɴ-ᴇꜱʜᴜ-ᴍᴅ-ᴠ1 ᴄᴏɴɴᴇᴄᴛᴇᴅ 💗
✦ ᴏᴡɴᴇʀ : ᴀᴄʜᴀʟᴀ ᴇꜱʜᴀɴ 
✦ ᴅᴇᴠᴇʟᴏᴘᴇʀ : ꜱᴜɴɴʏ-ʟᴋ
ᴇɴᴊᴏʏ ɴᴏᴡ ᴇꜱʜᴜ-ᴍᴅ-ᴠ1 🤖`;
  conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://telegra.ph/file/e84c85f6f6554f338f0c9-b29616e9df5cdba264.jpg` }, caption: up })
...
//================ownerreact
if(senderNumber.includes("94704932651")){
if(isReact) return
m.react("👨‍💻")
}
